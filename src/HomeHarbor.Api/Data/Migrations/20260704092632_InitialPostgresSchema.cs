    ...
    public partial class InitialPostgresSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilySpaces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManagedContainers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecoveryDrills", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReverseProxyRoutes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmbCredentials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmbShares", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StorageHealthSnapshots", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MediaAssets",
                columns: new[] { "FamilyId", "Area", "RelativePath" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "SmbShares",
                columns: new[] { "FamilyId", "ShareName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SyncStates_FamilyId_DeviceId_Scope",
                table: "SyncStates",
                columns: new[] { "FamilyId", "DeviceId", "Scope" },
                unique: true);
